...
var gtaLocator = (function GtaLocator(geoLocationApi) {
    ...
    var apiKey = "Esw0zDqm8Bx9YGW78eiUmXQC3MdyDTXx";
    ...
    return { // Start öffentlicher Teil des Moduls ...
        ...
        updateLocation: function() {
            ...
            tryLocate(function(position) {
                ...
                document.querySelector( ".tagmap img").src = getLocationMapSrc(latitude, longitude,  [],  14);
                //let source = getLocationMapSrc(latidude, longitude,  [],  14)
